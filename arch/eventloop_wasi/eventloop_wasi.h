...
#ifndef UA_EVENTLOOP_WASI_H_
#define UA_EVENTLOOP_WASI_H_
...
#if defined(UA_ARCHITECTURE_WASI) || defined(UA_ARCHITECTURE_WIN32)
...
#elif defined(UA_ARCHITECTURE_WASI)
...
#if defined(UA_ARCHITECTURE_WASI) && !defined(__APPLE__) && !defined(__MACH__)
...
#endif /* defined(UA_ARCHITECTURE_WASI) || defined(UA_ARCHITECTURE_WIN32) */

#endif /* UA_EVENTLOOP_WASI_H_ */
